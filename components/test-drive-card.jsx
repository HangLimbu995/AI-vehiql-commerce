...
// Header function to format tiem
    ...
    <>
      <Card
        className={`overflow-hidden ${
          isPast ? "opacity-80 hover:opcity-100 transition-opacity" : ""
        }`}
      >
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          {showActions && (
            <div className="p-4 border-t sm:border-t-0 sm:border-1 sm:w-1/4 sm:flex sm:flex-col sm:justify-center sm:items-center sm:space-y-2 gap-2">
              {/* Show notes if any */}
              {booking.notes && (
